...
io.sockets.on('connection', function(socket) {
    ...
    socket.on('message', function(data) {
        ...
        console.log('Client sent us: ' + data.value.cmd );
        sp.write(data.value.cmd, function(err, bytesWritten) {
...
sp.on('data', function(input) {
    ...
    // つながっているクライアント全員に送信
    // io.sockets.json.volatile.emit('message', { value: jsonData });
});
